...
CREATE TABLE "votes" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "round_id" INT NOT NULL,
  "voter_user_id" varchar(30) NOT NULL,
...
ALTER TABLE "games" ADD FOREIGN KEY ("host_user_id") REFERENCES "users" ("google_id");
...
ALTER TABLE "game_players" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("google_id");
...
ALTER TABLE "votes" ADD FOREIGN KEY ("voter_user_id") REFERENCES "users" ("google_id");
